...
public class BbsController {
	...
	/*
	@Autowired
		: 스프링 설정 파일에서 이미 생성된 빈을 자동으로 주입받고
		싶을 때 사용. 타입을 기반으로 자동주입되며, 만약 해당 타입의
	...
	*/
	...
	//글쓰기 - 폼에 진입 시에는 Get방식으로 처리
	@RequestMapping("/board/write.do")
	public String write(Model model) {
		return "07Board/write";
	}
	
	//글쓰기 - 폼값을 전송하므로 Post방식으로 처리
	...
	public String editAction(HttpServletRequest req,
		...
		/*
		뷰로 이동 시 redirect를 이용하면 해당 페이지로 리다이렉트(이동)된다.
